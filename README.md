.txt -> Qiime scripts used to processes the DNA sequences of the manuscript 'Pharmabiome analyses in tandem with chemometrics can help trace the provenance of falsified medicines: a proof-of-concept study'
